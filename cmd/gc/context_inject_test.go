...
// as 1M. claude-sonnet-5[1m] is the credit-billed 1M Sonnet variant; the bare
// claude-sonnet-5 a subscription session gets is 200K and must NOT read as 1M. gpt-5
...
func TestContextInjectResolvesWindowFromSharedModelTable(t *testing.T) {
	...
	tests := []struct {
		...
		{"claude-sonnet-5[1m]", 10_000, 680_000, 10_000, "700k/1000k"},
		{"claude-sonnet-5", 10_000, 130_000, 10_000, "150k/200k"},
