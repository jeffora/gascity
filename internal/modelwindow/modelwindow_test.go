...
func TestWindow(t *testing.T) {
	tests := []struct {
		...
		// Bare claude-sonnet-5 is 200K on a subscription session; its 1M form is
		// the credit-billed sonnet-5[1m], caught by the "[1m]" marker below.
		{"claude-sonnet-5", Default},
		{"claude-sonnet-5-20260101", Default}, // dated variant is still 200K
		{"claude-sonnet-5[1m]", Million},      // the credit-billed 1M variant
