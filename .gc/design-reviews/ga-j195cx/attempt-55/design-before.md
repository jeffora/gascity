...
and blocking test. CI compares the raw-consumer scan to the manifest after
every caller migration sub-phase. A raw predicate/filter site may be deleted
only when the same change removes its manifest row and adds or updates the
replacement test.
